...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[NSString class]]) {
        ...
        timeCell.contentView.backgroundColor = [UIColor colorWithR:230 G:230 B:230 Alpha:1];
        return timeCell;
    }
    else{
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(messageViewController:cellForMessageModel:)]) {
            ...
            if (cell) {
                if ([cell isKindOfClass:[EaseMessageCell class]]) {
                 ...
                 cell.contentView.backgroundColor = [UIColor colorWithR:230 G:230 B:230 Alpha:1];
                return cell;
            }
        }
        ...
        if (_dataSource && [_dataSource respondsToSelector:@selector(isEmotionMessageFormessageViewController:messageModel:)]) {
            ...
            if (flag) {
                ...
                sendCell.delegate = self;
                 ...
                 sendCell.contentView.backgroundColor = [UIColor colorWithR:230 G:230 B:230 Alpha:1];
                return sendCell;
            }
        }
