                       ...
                       reason:(EMGroupLeaveReason)aReason
{
    ...
    MessageViewController *chatViewContrller = nil;
    for (id viewController in viewControllers)
    {
        if ([viewController isKindOfClass:[MessageViewController class]] && [aGroup.groupId isEqualToString:[(MessageViewController *)viewController conversation].conversationId])
        {
...
- (MessageViewController*)_getCurrentChatView
{
    NSMutableArray *viewControllers = [NSMutableArray arrayWithArray:_mainVC.navigationController.viewControllers];
    MessageViewController *chatViewContrller = nil;
    for (id viewController in viewControllers)
